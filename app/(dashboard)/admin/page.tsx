    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-slate-50">Admin Panel</h1>
                ...
                <div className="flex items-center gap-4">
                    <div className="relative w-full md:w-64">
                        ...
                        <input 
                            className="w-full bg-white border border-gray-200 rounded-md pl-9 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent dark:bg-slate-950 dark:border-slate-800 dark:focus:ring-slate-300 dark:text-slate-50" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-6 rounded-xl bg-white border border-gray-200 shadow-sm flex flex-col gap-2 dark:bg-slate-950 dark:border-slate-800">
                    <div className="flex items-center justify-between">
                        <div className="text-sm font-medium text-gray-500">Total Pengguna</div>
                        <Users className="w-4 h-4 text-gray-500" />
                    </div>
                    <div className="text-2xl font-bold text-slate-900 dark:text-slate-50">128</div>
                </div>
                <div className="p-6 rounded-xl bg-white border border-gray-200 shadow-sm flex flex-col gap-2 dark:bg-slate-950 dark:border-slate-800">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="text-2xl font-bold text-slate-900 dark:text-slate-50">452</div>
                </div>
                <div className="p-6 rounded-xl bg-white border border-gray-200 shadow-sm flex flex-col gap-2 dark:bg-slate-950 dark:border-slate-800">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="text-2xl font-bold text-slate-900 dark:text-slate-50">Rp 12,4M</div>
                </div>
            </div>

            {/* User List Table Placeholder */}
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-950 dark:border-slate-800">
                <div className="p-6 border-b border-gray-200 dark:border-slate-800 flex items-center justify-between">
                    <h3 className="font-semibold text-lg tracking-tight text-slate-900 dark:text-slate-50">Pengguna Terbaru</h3>
                </div>
                                ...
                                <tr key={i} className="hover:bg-gray-50/50 dark:hover:bg-slate-900/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`px-2 py-1 rounded-md text-xs font-medium ${
                                            user.role === 'admin' ? 'bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-500' : 'bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-500'
                                        }`}>
                                            {user.role}
                                        </span>
                                    </td>
